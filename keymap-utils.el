...
;;  functions.  It was written for library `wid-keymap' but made available
;;  seperatly in the hope that it can be of use elsewhere also.
...
;;  it is for keymaps that have been created using the standart mechanisms
